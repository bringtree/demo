       ...
       <ul>
             ...
             <li class="listNav-li">
                    <el-dropdown class="listNav-dropdown"  >
                        ...
                        <el-dropdown-menu slot="dropdown" class="listNav-menu">
                            ...
                            <el-dropdown-item  v-on:click.native="routerGo(1,'/')" class="listNav-item">三防网格</el-dropdown-item>
                            ...
                            <el-dropdown-item  v-on:click.native="routerGo(1,'/')" class="listNav-item">物资库</el-dropdown-item>
            ...
            <li class="listNav-li">
                    <el-dropdown class="listNav-dropdown"  >
                        ...
                        <el-dropdown-menu slot="dropdown" class="listNav-menu">
                            <el-dropdown-item  v-on:click.native="routerGo(4,'/')" class="listNav-item">巡护人员</el-dropdown-item>
